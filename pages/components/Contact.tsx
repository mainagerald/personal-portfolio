  ...
  return (
    <div className="relative w-screen min-h-screen" id="contactMe">
          ...
          <div className="">
            <div className="flex flex-row items-center group cursor-pointer">
              <SocialIcon
                ...
                className=""
              />
              <Link href="https://github.com/mainagerald">
            ...
            <div className="flex flex-row items-center group cursor-pointer">
              <SocialIcon
                url="https://www.linkedin.com/in/flavian-maina-gerald/"
                bgColor="transparent"
                fgColor="#403D39"
                className=""
              />
              <Link href="https://www.linkedin.com/in/flavian-maina-gerald/">
                <p className="text-xl group-hover:font-medium transition-all duration-500 ease-in-out">
                  LinkedIn
                </p>
              </Link>
      ...
      <p className="mb-10 w-full flex items-center text-center justify-center bottom-2">
        {/* Made with ❤️️ and ofcourse Next.js, Tailwind CSS, Sanity and GSAP */}
      </p>
    </div>
  );
}
